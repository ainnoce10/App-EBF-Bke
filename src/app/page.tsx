      ...
      <section className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-2 sm:py-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={`transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'} md:order-1`}>
            <div className="relative w-full h-80 sm:h-96 md:h-[500px] lg:w-4/5 lg:mx-auto rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-105 bg-gray-100">
              <Image
              ...
              <div className="absolute bottom-0 left-6 right-6 text-white pb-2">
                ...
                <button 
                  ...
                  className="text-sm px-4 py-2 rounded-full font-semibold border border-yellow-400 text-white hover:bg-yellow-400 hover:text-white bg-transparent transition-all duration-300"
                >
